...
class MasterGrader:
    ...
    def log_error(self, error_info: Dict):
        ...
        if config.Config.DETAILED_LOGGING:
            print(f"  ⚠ {error_info.get('message', 'خطا')}")
    ...
    def step1_extraction(self) -> bool:
        ...
        """
        print("\n" + "="*80)
        print("📦 مرحله 1: استخراج بازگشتی فایل‌های ZIP (Sandbox)")
        print("="*80)
    ...
    def step2_organization(self) -> bool:
        ...
        """
        print("\n" + "="*80)
        print("📁 مرحله 2: سازماندهی و نگاشت هوشمند فایل‌ها")
        print("="*80)
    ...
    def step3_plagiarism_detection(self) -> bool:
        ...
        """
        print("\n" + "="*80)
        print("🔎 مرحله 3: تشخیص تقلب با الگوریتم توکن‌سازی")
        print("="*80)
    ...
    def run(self) -> bool:
        ...
        if not self.step1_extraction():
            print("\n⚠ هشدار: مرحله استخراج با خطا مواجه شد، اما ادامه می‌دهیم...")
        ...
        if not self.step3_plagiarism_detection():
            print("\n⚠ هشدار: مرحله تشخیص تقلب با خطا مواجه شد.")
        
        # مرحله 4: گزارش‌دهی
        if not self.step4_reporting():
            print("\n⚠ هشدار: مرحله گزارش‌دهی با خطا مواجه شد.")
    ...
    def cleanup_temp_dirs(self):
        """پاکسازی پوشه‌های موقت"""
        print(f"\n🧹 در حال پاکسازی {len(self.temp_dirs)} پوشه موقت...")
...
def main():
    ...
    try:
        ...
        if success:
            ...
            print("\n⚠ برنامه با خطا به پایان رسید. لطفاً لاگ‌ها را بررسی کنید.")
            return 1
